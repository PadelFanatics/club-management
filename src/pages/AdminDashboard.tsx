    ...
    return (
      <div>
        <button 
          ...
          className="mb-6 px-4 py-2 text-red-900 hover:bg-red-50 rounded-lg flex items-center"
        >
          ← Back to Clubs
        </button>
        <ClubSettings />
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between">
                <button 
                  ...
                  className="px-4 py-2 text-red-900 hover:bg-red-50 rounded-lg flex items-center"
                >
